...
<head>
    ...
    <script type="text/javascript" src="Public/Js/RéinitialisationForm.js" defer></script>
    ...
    <body>
        ...
        <h1>Transfert de fichiers</h1> 
            ...
            <form method="POST" id="formulaire" action="Src/RecupDonnees.php" enctype="multipart/form-data">
